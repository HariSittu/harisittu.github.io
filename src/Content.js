      ...
      <div>
        <div className={homeClasses}>
          <div className={social}>
            <ul>
              <li><a href="https://www.linkedin.com/in/hariharan-vinayagam-0b4b2282/">LinkedIn</a></li>
              <li><a href="https://github.com/HariSittu">GitHub</a></li>
            </ul>
          </div>
        ...
        <div className={aboutProjectClasses}>
          <div className={aboutBox}>
            <h1>Currently, I{`'`}m in <span className={highlight}>Chennai</span> designing and developing <span className={underline}>full-stack</span> web application solutions.</h1>
            <br />
            <ul>{ skillsList }</ul>
          </div>
